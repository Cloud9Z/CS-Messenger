...
public class loggedIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(welcomeUserLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(10, 10, 10)
        ...
        this.addWindowListener(new WindowAdapter()
        {
            ...
            {	
            	// If user has logged out, dispose of frame; prevents circular confirmations
            	if(gui.isLoggedOut()) {
            		thisScreen.dispose();
            		return;
            	}
            	// Else, prompt for confirmation
            	AreYouSure confirmScreen = new AreYouSure(gui, thisScreen, true);
    ...
    /**
     * Open selection screen for new group chat.
     * 
     * @param evt
     */

...
/**
 * This class contains the JFrame for groupChat. 
 * 
 * It implements the ChatWindow class and in addition it contains a list of all the users present in that instance of groupChat. 
 * Also, groupChat is only available while all users participating are online, and when a user goes offline or closes the groupChat 
 * window, the groupChat frame will be disabled and the groupChatDisconnected dialog will be displayed for the remaining users
 * participating. 
 */
public class groupChat extends javax.swing.JFrame implements ChatWindow {
     ...
     */
    public groupChat(MessengerGUI gui, Set<String> members) {
        this.gui = gui;
    ...
    private void initComponents() {
        ...
        setTitle("Group Chat: " + members.toString() + " - Messenger");
        setResizable(false);
